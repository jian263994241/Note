define(function(){
    function swf(d,a,b,eid){
        if (navigator.appName.indexOf("Microsoft") != -1) {
            ...
            return '<embed src="'+d+'" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" id="'+eid+'" name="'+eid+'" bgcolor="#000000" width="'+a+'" height="'+b+'" allowscriptaccess="always" quality="High" wmode="transparent" allowFullScreen="true"></embed>';
        }
    };
